...
class GitHubApiException implements Exception {
  ...
  /// When the rate limit lifts (`X-RateLimit-Reset`); only set for
...
class GithubApi {
  ...
  Future<GitHubAccount> currentUser() async {
    ...
    return GitHubAccount.fromJson(_asMap(data));
  }
  ...
  Future<List<WorkflowRun>> listRuns(
    ...
    return [
      for (final item in _asList(data['workflow_runs']))
  ...
  Future<List<RunJob>> listJobs(String owner, String name, int runId) async {
    ...
    return [for (final item in _asList(data['jobs'])) RunJob.fromJson(item)];
  }
