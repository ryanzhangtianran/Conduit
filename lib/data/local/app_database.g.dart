...
class $PortForwardConfigsTable extends PortForwardConfigs
  ...
  static const VerificationMeta _proxySchemeMeta = const VerificationMeta(
    'proxyScheme',
  );
  @override
  late final GeneratedColumn<String> proxyScheme = GeneratedColumn<String>(
    'proxy_scheme',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('proxy_scheme')) {
      context.handle(
        _proxySchemeMeta,
        proxyScheme.isAcceptableOrUnknown(
          data['proxy_scheme']!,
          _proxySchemeMeta,
        ),
      );
  ...
  PortForwardConfig map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PortForwardConfig(
      ...
      proxyScheme: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}proxy_scheme'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class PortForwardConfig extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || proxyScheme != null) {
      map['proxy_scheme'] = Variable<String>(proxyScheme);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  ...
  PortForwardConfigsCompanion toCompanion(bool nullToAbsent) {
    return PortForwardConfigsCompanion(
      ...
      proxyScheme: proxyScheme == null && nullToAbsent
          ? const Value.absent()
          : Value(proxyScheme),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
  ...
  factory PortForwardConfig.fromJson(
    ...
    return PortForwardConfig(
      ...
      proxyScheme: serializer.fromJson<String?>(json['proxyScheme']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'proxyScheme': serializer.toJson<String?>(proxyScheme),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
  }
  ...
  PortForwardConfig copyWith({
    ...
    bool? autoStart,
    bool? keepAlive,
    Value<String?> proxyScheme = const Value.absent(),
    DateTime? createdAt,
    DateTime? updatedAt,
  }) => PortForwardConfig(
    id: id ?? this.id,
    ...
    proxyScheme: proxyScheme.present ? proxyScheme.value : this.proxyScheme,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  );
  PortForwardConfig copyWithCompanion(PortForwardConfigsCompanion data) {
    return PortForwardConfig(
      ...
      proxyScheme: data.proxyScheme.present
          ? data.proxyScheme.value
          : this.proxyScheme,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  ...
  bool operator ==(Object other) =>
      ...
      (other is PortForwardConfig &&
          ...
          other.proxyScheme == this.proxyScheme &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt);
}
...
class PortForwardConfigsCompanion extends UpdateCompanion<PortForwardConfig> {
  ...
  final Value<String?> proxyScheme;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
  const PortForwardConfigsCompanion({
    ...
    this.proxyScheme = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  });
  ...
  static Insertable<PortForwardConfig> custom({
    ...
    return RawValuesInsertable({
      ...
      if (proxyScheme != null) 'proxy_scheme': proxyScheme,
      if (createdAt != null) 'created_at': createdAt,
      if (updatedAt != null) 'updated_at': updatedAt,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (proxyScheme.present) {
      map['proxy_scheme'] = Variable<String>(proxyScheme.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
class $$PortForwardConfigsTableFilterComposer
  ...
  ColumnFilters<String> get proxyScheme => $composableBuilder(
    column: $table.proxyScheme,
    builder: (column) => ColumnFilters(column),
  );
...
class $$PortForwardConfigsTableOrderingComposer
  ...
  ColumnOrderings<String> get proxyScheme => $composableBuilder(
    column: $table.proxyScheme,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$PortForwardConfigsTableAnnotationComposer
  ...
  GeneratedColumn<String> get proxyScheme => $composableBuilder(
    column: $table.proxyScheme,
    builder: (column) => column,
  );
