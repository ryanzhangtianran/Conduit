...
class ServerDraft {
  ...
  /// Transport used to reach this server: `ssh` for a remote host, `local`
  /// for this computer.
...
enum ServerConnectionType { ssh, local }
...
class SshSessionInfo {
  ...
  /// server signs in with a key or a password. Null for local sessions.
