...
''';
  ...
  group('OpenSshConfigAdapter.supports', () {
    test('recognizes OpenSSH config and rejects everything else', () {
      ...
      expect(adapter.supports('random text'), isFalse);
      expect(adapter.supports('{"name":"prod"}'), isFalse);
    });
  });
