...
final class TerminalTheme {
  ...
  /// Line height as a multiple of the font's natural line extent.
  ///
  /// 1.0 keeps the font's own metrics; larger values add leading that is
  /// split evenly above and below each row of cells.
