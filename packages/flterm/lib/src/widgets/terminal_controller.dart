...
abstract class TerminalController extends ChangeNotifier
  ...
  /// Called when terminal content asks to replace the host clipboard
  /// (OSC 52 and iTerm2 copy requests), already decoded by libghostty.
  ///
  /// Return the outcome of committing the write. When unset, clipboard
  /// writes are reported as unsupported and otherwise ignored.
  ClipboardWriteCallback? onClipboardWrite;
