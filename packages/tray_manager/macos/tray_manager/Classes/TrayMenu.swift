...
public class TrayMenu: NSMenu, NSMenuDelegate {
    ...
    public init(_ args: [String: Any]) {
        ...
        for item in items {
            ...
            // Conduit addition: optional small native image next to the label.
            if let iconBase64 = itemDict["iconBase64"] as? String,
               let data = Data(base64Encoded: iconBase64, options: .ignoreUnknownCharacters),
